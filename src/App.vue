<template>
  ...
  <span>Código A: <input type="text"><span v-informacao:simples.umClickMouse="'Você encontrará o código A na parte frontal do equipamento.'">i</span></span><br>
  <span>Código B: <input type="text"><span v-informacao:destacado.doisClickMouse="'Você encontrará o código B na parte trazeira do equipamento.'">i</span></span>
</template>
